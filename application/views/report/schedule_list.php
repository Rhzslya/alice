				...
				<tbody>
					...
					<?php foreach($result as $row):?>
						...
						<tr style="font-size: 0.9em">
							...
							<td>
								<a href="<?=base_url('comeon/rebackup/'.$row->uc)?>" class="btn btn-sm btn-success mx-2"><i class="fa fa-file-export"></i> &nbsp; Re-export Result</a>
								<a href="<?=base_url('comeon/daily_manage/'.$row->uc)?>" class="btn btn-info btn-sm">
									<i class="fa fa-boxes"></i> &nbsp; Daily Manage
								</a>
							</td>
						</tr>
					<?php endforeach;?>
...
<div class="modal fade" id="form_import_bulk">
	<div class="modal-dialog">
		<div class="modal-content">

			<?=form_open_multipart('report/upload_bulk')?>
			<!-- Modal Header -->
			<div class="modal-header">
				<h4 class="modal-title">Import Bulk</h4>
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
