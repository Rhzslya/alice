...
<div class="main-pane">
	<div class="title-menu">User Add</div>

	<div class="main-home">
		
		<div class="form-area">
		<?=form_open_multipart('user/insert', array('id' => 'add-form'))?>
			<div class="form-adit">
				<div class="result-user ">
					...
					<table class="form-frame" width="800" height="120">
						<tr>
							...
							<td width="50%"><input type="text" name="f_id_number" size="30" required=""></td>
						</tr>
						<tr>
							<td>Full Name</td>
							<td><input type="text" name="f_full_name" size="30" required=""></td>
						</tr>
						<tr>
							<td>Username</td>
							<td><input type="text" name="f_username" size="30" required=""></td>
						</tr>
						<tr>
							<td>Password</td>
							<td><input type="password" name="f_password" size="30" required=""></td>
						</tr>
						<tr>
							<td>Retype Password</td>
							<td><input type="password" name="f_retype" size="30"></td>
						</tr>
						<tr>
							<td>Photo</td>
							<td><input type="file" name="f_photo"></td>
						</tr>
						<tr>
							<td>Type User</td>
							<td>
								<input type="radio" name="f_user_type"  class="btn-type-user" value="1" checked="">Kepala
								<input type="radio" name="f_user_type" class="btn-type-user"  value="2">Administrator
							</td>
						</tr>
					</table>
