...
<div>
	<table align="center" width="100%">
		<tr>
			<td width="120" valign="top"><b>Full Name</b></td>
			...
			<td width="150" valign="top"><b>Examination Code</b></td>
			<td width="15" valign="top">&nbsp;:</td>
			<td valign="top">
				<?=$row->exam_code?>
			</td>
	...
	<h4>Question List and Answer</h4>
	<br />
	<?php if ($row->is_done != 0): ?>
		...
		<?php for ($i=0; $i<$max_question; $i++) : ?>
			...
			<div style="/*border: 1px solid black;*/ width: 900px; padding: 5px; margin-bottom: 25px;">
				<div style="/*border: 1px solid blue;*/ width: 20px; float: left; font-size: 12pt; font-weight: bold;">
					<?=$i+1?>.
				</div>
					...
					<?php if ($question_type[$i] == 1) : ?>
						...
						<table class="options-true">
							...
							<?php 
								...
								if ($answers[$i] == "0") {
									$background_idk = "background-color: #F39494;";

									$style_idk = "border: 1px solid black; border-radius: 4px; margin-bottom: 5px; ".$background_idk;
								}
							?>
