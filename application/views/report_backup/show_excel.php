...
$filename = $level."-".$row->exam_code."(".$prapas.")"."-".$sequence."-".$competency_name.".xls"; 
$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
//force user to download the Excel file without writing it to server's HD
// $objWriter->save(str_replace(__FILE__,$name_folder.'/'.$filename.'.xls',__FILE__));
$objWriter->save(str_replace(__FILE__,$name_folder.'/'.$filename,__FILE__));
