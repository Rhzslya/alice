<div class="container-fluid">
	<h1 class="text-uppercase">Period Report</h1>
</div>
		...
		<?php if(isset($result)):?>
			<table class="table table-striped">
				<thead class="thead-dark">
					<th width="270">Subject Title</th>
					<th width="220">From - Until</th>
					<th>Location</th>
					...
					<?php foreach($result as $row):?>
						...
						<tr style="font-size: 0.9em">
							...
							<td>
								...
								<!--
								<a href="<?=base_url('report/upload')?>" class="btn btn-sm btn-warning text-white"><i class="fa fa-file-alt"></i> &nbsp; Detail</a>
								-->
